...
@section('content')
        ...
        function getProducts(r,supp,price,qty) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    t.clear().draw();
                    var invoiceDetailsOption = ' <p class="alert " style="color:black; border:1px solid black;"> Purchase ID: <label id="display_ID" class="label" style="font-size:13px; color:red;border:1px solid black; border-radious: 10/8px;">' +r+ '</label>\n' +
                        '\n' +
                        '                                      <br><br>\n' +
                        ...
                        '\n' +
                        '\n' +
                        '                                 <button class="btn btn-danger" data-toggle="modal" data-target="#invoiceAdd" onclick="checkBoxID('+r+')"><i class="fa fa-cart-plus"></i> Add new product to the invoice</button>';
                    ...
                    $.each(response, function (i, data) {
                        ...
                        //getParticularSale(r,productInfo);
                        ...
                        @foreach ($products as $product)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{URL::to('/makepdfpurchase/'.$product->boxID)}}" class="btn btn-danger btn-sm" ><i class="fa fa-print"></i></a>
    ...
    @component('components.modal')
        ...
        @slot('title')
            Add new purchase details details
        @endslot
        @slot('body')
